...
class AdaptiveImageWorkspace(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.layout_choice.setObjectName("gridLayoutChoice")
        self.layout_choice.addItems(list(self.LAYOUT_CAPACITY))
        self.layout_choice.setFixedSize(66, 32)
        self.layout_choice.currentTextChanged.connect(self._layout_changed)
        self.previous_button = QPushButton("Previous")
        self.previous_button.setObjectName("gridPreviousButton")
        self.next_button = QPushButton("Next")
        self.next_button.setObjectName("gridNextButton")
        self.previous_button.setFixedSize(112, 32)
        self.next_button.setFixedSize(88, 32)
        ...
        self.page_label.setObjectName("gridPageLabel")
        self.page_label.setFixedWidth(100)
        self.page_label.setAlignment(Qt.AlignCenter)
        self.reset_button = QPushButton("Reset Grid")
        self.reset_button.setObjectName("gridResetButton")
        self.reset_button.setFixedSize(126, 32)
        self.reset_button.clicked.connect(self.reset_grid)
        grid_label = QLabel("Grid")
        grid_label.setObjectName("gridToolbarLabel")
        grid_label.setFixedWidth(42)
